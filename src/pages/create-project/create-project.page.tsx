...
import { CreateProjectSchema, CreateProjectSchemaType } from "./create-proejct.contract.ts";
...
export const CreateProject = () => {
    ...
    const { register, handleSubmit, formState: { errors, isValid } } = useForm<CreateProjectSchemaType>({
